    ...
    private function render_optimization_recommendations($performance_stats, $cache_stats) {
        ...
        <div class="folio-optimization-recommendations">
            ...
            <div class="debug-info" style="background: #f0f0f0; padding: 10px; margin: 10px 0; border-radius: 4px; font-size: 12px;">
                ...
                <?php esc_html_e('Cache hit rate:', 'folio'); ?> <?php echo number_format($cache_stats['overall_hit_rate'], 1); ?>%<br>
                ...
                <?php esc_html_e('Memory usage:', 'folio'); ?> <?php echo size_format($performance_stats['memory_usage']); ?><br>
                <?php esc_html_e('Database queries:', 'folio'); ?> <?php echo $performance_stats['db_queries']; ?><br>
                <?php esc_html_e('Recommendation count:', 'folio'); ?> <?php echo count($recommendations); ?>
            </div>
            <?php endif; ?>
