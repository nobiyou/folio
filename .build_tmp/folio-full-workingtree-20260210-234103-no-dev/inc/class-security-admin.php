                ...
                <?php else : ?>
                    <?php foreach ($grouped_nets as $spider_id => $group) : ?>
                        <div class="spider-group" style="margin-bottom: 30px; padding: 15px; border: 1px solid #ddd; border-radius: 4px;">
                            <h3><?php echo esc_html($group['spider_name']); ?> (ID: <?php echo $spider_id; ?>) - <?php echo sprintf(esc_html__('%d ranges', 'folio'), count($group['nets'])); ?></h3>
                                ...
                                <tbody>
                                    <?php foreach ($group['nets'] as $net) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="button button-small delete-spider-net" data-id="<?php echo $net['id']; ?>"><?php echo esc_html__('Delete', 'folio'); ?></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                        ...
                        <tbody>
                            <?php foreach ($reports as $report) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="button button-small view-report" data-id="<?php echo $report['id']; ?>"><?php echo esc_html__('View', 'folio'); ?></button>
                                        <button type="button" class="button button-small compare-report" data-id="<?php echo $report['id']; ?>"><?php echo esc_html__('Compare', 'folio'); ?></button>
                                        <button type="button" class="button button-small delete-report" data-id="<?php echo $report['id']; ?>"><?php echo esc_html__('Delete', 'folio'); ?></button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
