...
if (!class_exists('folio_Membership_Notifications')) {
    echo '<div class="error-message">通知系统未初始化</div>';
    return;
}
...
<div class="notifications-page">
    <div class="flex items-center justify-between mb-6">
        <h1 class="page-title text-2xl font-bold">
            ...
            <span class="unread-badge ml-3 bg-red-500 text-white text-sm rounded-full px-3 py-1">
                <?php printf(esc_html__('%d 条未读', 'folio'), $unread_count); ?>
            </span>
            <?php endif; ?>
        </h1>
    ...
    <div class="empty-state text-center py-12">
        ...
        <h3 class="empty-state-title text-lg font-medium mb-2"><?php esc_html_e('暂无通知', 'folio'); ?></h3>
        <p class="empty-state-text text-gray-600"><?php esc_html_e('您还没有收到任何通知', 'folio'); ?></p>
    </div>
    <?php else : ?>
