    ...
    <div id="folio-notification-popup" style="display: none;">
        ...
        <div class="notification-modal">
            <div class="notification-header">
                <h3><?php esc_html_e('我的通知', 'folio'); ?></h3>
                <div style="display: flex; gap: 10px; align-items: center;">
                    <button id="mark-all-read-btn" class="mark-all-read-btn" style="display: none; background: #0073aa; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 12px;">
                        <?php esc_html_e('全部已读', 'folio'); ?>
                    </button>
                    <button class="notification-close" aria-label="<?php esc_attr_e('关闭', 'folio'); ?>" style="background: none; border: none; font-size: 24px; color: #6b7280; cursor: pointer; padding: 4px; border-radius: 4px; transition: all 0.2s ease;">&times;</button>
                </div>
            </div>
            <div class="notification-content">
                <div id="notification-list">
                    <div class="no-notifications"><?php esc_html_e('加载中...', 'folio'); ?></div>
                </div>
            </div>
        </div>
    </div>
