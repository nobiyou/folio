    ...
    $(document).ready(function() {
        ...
        function handleSuccess(data, action) {
            ...
            if (data.excerpt) {
                ...
                message += '✓ ' + (folioAI.strings.excerpt_generated || 'Excerpt generated') + '<br>';
            }
            
            // 更新标签
            if (data.tags && data.tags.length > 0) {
                updateTags(data.tags);
                message += '✓ ' + (folioAI.strings.keywords_generated || 'Keywords generated') + ': ' + data.tags.join(', ');
            }
        ...
        function handleError(message) {
            $('.folio-ai-result')
                .addClass('error')
                .html('<strong>' + (folioAI.strings.error_label || 'Error:') + '</strong>' + message)
                .show();
        }
