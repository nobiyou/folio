...
class Folio_Theme_Enhancements {
    ...
    public static function render_breadcrumbs() {
        ...
        $home_title = __('Home', 'folio');
        
        echo '<nav class="breadcrumbs" aria-label="' . esc_attr__('Breadcrumb Navigation', 'folio') . '">';
        ...
        if (is_category()) {
            ...
            echo '<li class="breadcrumb-item active" aria-current="page">' . esc_html__('Search Results', 'folio') . ': ' . esc_html(get_search_query()) . '</li>';
            
        } elseif (is_404()) {
            echo '<li class="breadcrumb-item active" aria-current="page">' . esc_html__('404 Error', 'folio') . '</li>';
        }
